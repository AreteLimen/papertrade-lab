...
**Открытый вопрос praxis: replay-пара с ТЕМ ЖЕ run_id или разным? → РАЗРЕШЁН 19.07 в [[DR-004]]: РАЗНЫЕ run_id + общий replay_group_id + нормализованное сравнение (исключить инстанс-id и физвремя). Ниже — исходная развилка, оставлена для истории.**
